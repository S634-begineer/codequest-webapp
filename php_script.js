...
const questions = [
    {
        title: "Question-1",
        text: "Write a PHP script to print 'Hello, World!'"
    },
    {
        title: "Question-2",
        text: "Write a PHP script that takes a name and age from the user and prints: 'Name: John, Age: 25'"
    },
    {
        title: "Question-3",
        text: "Create a simple calculator using switch-case for +, -, *, / operations."
    },
    {
        title: "Question-4",
        text: "Check if a number is even or odd using if-else."
    },
    {
        title: "Question-5",
    ...
    {
        title: "Question-6",
        text: "Accept an array of integers and print the sum and average."
    },
    {
        title: "Question-7",
        text: "Sort an array of strings in alphabetical order and print them."
    },
    {
        title: "Question-8",
        text: "Create a PHP associative array with keys as product names and values as prices. Print all key-value pairs."
    },
    {
        title: "Question-9",
        text: "Write a PHP script to check whether a given year is a leap year."
    },
    {
        title: "Question-10",
        text: "Write a PHP script that counts the number of vowels in a string."
    },
    {
        title: "Question-11",
        text: "Write a PHP function to reverse a string without using built-in reverse functions."
    },
    {
        title: "Question-12",
        text: "Create a login form that accepts username and password using POST method and displays them."
    },
    {
        title: "Question-13",
        text: "Write a PHP script to read a file and display its contents."
    },
    {
        title: "Question-14",
        text: "Write a script to create a file named `hello.txt` and write 'PHP is awesome!' to it."
    },
    {
        title: "Question-15",
        text: "Create a function that accepts a string and returns true if it is a palindrome."
    }
];
