...
  {
    title: "Question-1",
    text: "Write a Kotlin program to print 'Hello, Kotlin World!'"
  },
  {
    title: "Question-2",
    text: "Write a program that takes your name and age as input and prints: 'Name: Alex, Age: 25'"
  },
  {
    title: "Question-3",
...
  {
    title: "Question-4",
    text: "Create a function that returns the factorial of a given number using recursion."
  },
  {
    title: "Question-5",
    text: "Write a program to find the largest element in an array."
  },
  {
    title: "Question-6",
    text: "Write a Kotlin program to reverse a given string."
  },
  {
    title: "Question-7",
    text: "Check if a given string is a palindrome or not."
  },
  {
    title: "Question-8",
    text: "Create a class `Person` with name and age. Add a method to display the info."
  },
  {
    title: "Question-9",
    text: "Write a Kotlin program to print the first N Fibonacci numbers."
  },
  {
    title: "Question-10",
    text: "Create a function that returns true if the input number is a prime number."
  },
  {
    title: "Question-11",
    text: "Use a `when` expression to check if a number is positive, negative, or zero."
  },
  {
    title: "Question-12",
    text: "Write a function that takes a list of integers and returns the sum of all even numbers."
  },
  {
    title: "Question-13",
    text: "Create a data class `Book` with title, author, and price. Instantiate and print its details."
  },
  {
    title: "Question-14",
    text: "Write a Kotlin program to count the number of vowels in a string."
  },
  {
    title: "Question-15",
    text: "Create an extension function on `String` to capitalize the first character."
  }
];
