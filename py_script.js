...
const questions = [
  {
    title: "Question-1",
    text: "Write a Python program to check if a number is positive, negative, or zero."
  },
  {
    title: "Question-2",
    text: "Take a string as input and count the number of uppercase and lowercase letters."
  },
  {
    title: "Question-3",
    text: "Create a list of numbers from 1 to 10 using list comprehension."
  },
  {
    title: "Question-4",
    text: "Write a Python function to check if a given string is a pangram (contains all alphabets)."
  },
  {
    title: "Question-5",
    text: "Accept a list of integers and print only the even numbers using a lambda and filter."
  },
  {
    title: "Question-6",
    text: "Write a program that reverses the words in a sentence input by the user."
  },
  {
    title: "Question-7",
    text: "Create a dictionary from two lists: one of keys and one of values."
  },
  {
    title: "Question-8",
  ...
  {
    title: "Question-9",
    text: "Define a class `Rectangle` with length and breadth. Add methods to compute area and perimeter."
  },
  {
    title: "Question-10",
    text: "Write a Python program to read a file and count the frequency of each word."
  },
  {
    title: "Question-11",
    text: "Use `map()` to square all elements of a given list."
  },
  {
    title: "Question-12",
    text: "Write a program to remove duplicates from a list and print the unique items."
  },
  {
    title: "Question-13",
    text: "Create a Python script to print the current date and time using the `datetime` module."
  },
  {
    title: "Question-14",
    text: "Implement a try-except block to handle division by zero."
  },
  {
    title: "Question-15",
    text: "Use a generator function to yield even numbers up to a given limit."
  }
];
